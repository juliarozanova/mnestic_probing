...
from experiments.constants import AMNESIC_PATH, MODEL_NAMES
...
def run_amnesic_probing(model_name, label_column):
    ...
    TRAIN_DATA_PATH = Path(f'./experiments/encoded_data/{model_name}/train/')
    DEV_DATA_PATH = Path(f'./experiments/encoded_data/{model_name}/dev/')
    TEST_DATA_PATH = Path(f'./experiments/encoded_data/{model_name}/test/')
