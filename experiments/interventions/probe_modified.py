...
from probe_ably import ProbingExperiment, ProbingTask, ProbingRepresentation
...
tasks: ProbingTask = [prepared_data[key] for key in prepared_data.keys()]
